...
namespace Practice_Linq
{
    public class Program
    {
        ...
        //вивід матчів на екран
        static void Print(FootballGame game)
        {
        ...
        static void Query1(List<FootballGame> games)
        {
            ...
            var selectedGames = games.Where(game => game.Country == "Ukraine" && game.Date.Year == 2012);
        ...
        static void Query4(List<FootballGame> games)
        {
            ...
            var selectedGames = games.Where(game => game.Away_team == "Germany" && (game.Date.Year <= 2020 && game.Date.Year >= 2018) && game.Away_score < game.Home_score);
        ...
        static void Query5(List<FootballGame> games)
        {
            ...
            var selectedGames = games.Where(game => game.Tournament == "UEFA Euro qualification" && (game.City == "Kyiv" || game.City == "Kharkiv") && game.Home_score > game.Away_score);
        ...
        static void Query8(List<FootballGame> games)
        {
            ...
            var selectedGames = games.Where(game => game.Tournament == "UEFA Euro" && game.Country == "Ukraine")
                .Select(game => new { MatchYear = game.Date.Year, Team1 = game.Home_team, Team2 = game.Away_team, Goals = game.Home_score + game.Away_score });
        ...
        static void Query9(List<FootballGame> games)
        {
            ...
            var selectedGames = games.Where(game => game.Tournament == "UEFA Nations League" && game.Date.Year == 2023)
                .Select(game => new { MatchYear = game.Date.Year, Game = $"{game.Home_team}-{game.Away_team}", 
